...
export PATH=~/go/bin/:~/.cargo/bin:~/.pub-cache/bin:~/.android-studio/bin:~/.local/bin:~/.dotnet/tools:~/.dotnet/shared:~/.dotnet:$PATH
...
export MSBuildSDKsPath=~/.dotnet/sdk/$(dotnet --version)/Sdks
